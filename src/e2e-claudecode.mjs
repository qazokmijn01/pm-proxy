...
const CASES = [
  ...
  { name: 'Read: duong dan tuong doi -> noi vao thu muc du an', native: 'readFile', args: { filePath: 'src/map.mjs' }, tool: 'Read',
    check: (i) => i.file_path === 'C:/du/an/src/map.mjs' },
  { name: 'Write: duong dan tuong doi -> noi vao thu muc du an', native: 'createFile', args: { filePath: 'out/x.txt', content: 'a' }, tool: 'Write',
    check: (i) => i.file_path === 'C:/du/an/out/x.txt' },
  { name: 'Edit: duong dan tuong doi -> noi vao thu muc du an', native: 'editFile', args: { filePath: 'src/a.mjs', oldString: 'x', newString: 'y' }, tool: 'Edit',
    check: (i) => i.file_path === 'C:/du/an/src/a.mjs' },
  { name: 'Read: duong dan POSIX tuyet doi giu nguyen', native: 'readFile', args: { filePath: '/tmp/a.txt' }, tool: 'Read',
    check: (i) => i.file_path === '/tmp/a.txt' },
